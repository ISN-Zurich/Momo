 ...
 */
class ApplicationScopeValueTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'momo.map.ApplicationScopeValueTableMap';
	...
	public function initialize()
	{
		...
		$this->setPhpName('ApplicationScopeValue');
		$this->setClassname('ApplicationScopeValue');
