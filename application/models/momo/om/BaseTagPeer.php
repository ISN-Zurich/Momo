...
abstract class BaseTagPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'DayId', 'UserId', 'ExpirationDate', 'Type', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'dayId', 'userId', 'expirationDate', 'type', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DAY_ID, self::USER_ID, self::EXPIRATION_DATE, self::TYPE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DAY_ID', 'USER_ID', 'EXPIRATION_DATE', 'TYPE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'day_id', 'user_id', 'expiration_date', 'type', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DayId' => 1, 'UserId' => 2, 'ExpirationDate' => 3, 'Type' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'dayId' => 1, 'userId' => 2, 'expirationDate' => 3, 'type' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DAY_ID => 1, self::USER_ID => 2, self::EXPIRATION_DATE => 3, self::TYPE => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DAY_ID' => 1, 'USER_ID' => 2, 'EXPIRATION_DATE' => 3, 'TYPE' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'day_id' => 1, 'user_id' => 2, 'expiration_date' => 3, 'type' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(TagPeer::DAY_ID);
			$criteria->addSelectColumn(TagPeer::USER_ID);
			$criteria->addSelectColumn(TagPeer::EXPIRATION_DATE);
			$criteria->addSelectColumn(TagPeer::TYPE);
		} else {
	...
	public static function doCountJoinDay(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TagPeer::DAY_ID, DayPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Tag objects pre-filled with their Day objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Tag) to the collection in $obj2 (Day)
				$obj2->addTag($obj1);
	...
	/**
	 * Selects a collection of Tag objects pre-filled with all related objects except Day.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Tag objects pre-filled with all related objects except User.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
