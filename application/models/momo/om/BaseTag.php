 ...
 */
abstract class BaseTag extends BaseObject 
{
	...
	public function setDayId($v)
	{
		...
		if ($this->day_id !== $v) {
			$this->day_id = $v;
			$this->modifiedColumns[] = TagPeer::DAY_ID;
		}
	...
	public function setExpirationDate($v)
	{
		...
		if ($this->expiration_date !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = TagPeer::EXPIRATION_DATE;
			}
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = TagPeer::TYPE;
		}
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(TagPeer::DAY_ID)) {
			$modifiedColumns[':p' . $index++]  = '`DAY_ID`';
		}
		if ($this->isColumnModified(TagPeer::USER_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USER_ID`';
		}
		if ($this->isColumnModified(TagPeer::EXPIRATION_DATE)) {
			$modifiedColumns[':p' . $index++]  = '`EXPIRATION_DATE`';
		}
		if ($this->isColumnModified(TagPeer::TYPE)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TagPeer::DAY_ID)) $criteria->add(TagPeer::DAY_ID, $this->day_id);
		if ($this->isColumnModified(TagPeer::USER_ID)) $criteria->add(TagPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(TagPeer::EXPIRATION_DATE)) $criteria->add(TagPeer::EXPIRATION_DATE, $this->expiration_date);
		if ($this->isColumnModified(TagPeer::TYPE)) $criteria->add(TagPeer::TYPE, $this->type);
