...
/**
 * Base class that represents a row from the 'projectentries' table.
 *
 * 
 *
 * @package    propel.generator.momo.om
 */
abstract class BaseProjectEntry extends Entry 
{

	/**
	 * Peer class name
	 */
	const PEER = 'ProjectEntryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ProjectEntryPeer
	 */
	 ...
	 * @return     ProjectEntry The current object (for fluent API support)
	 */
	public function setProjectId($v)
	{
		...
		if ($this->project_id !== $v) {
			$this->project_id = $v;
			$this->modifiedColumns[] = ProjectEntryPeer::PROJECT_ID;
		}
	...
	public function setTeamId($v)
	{
		...
		if ($this->team_id !== $v) {
			$this->team_id = $v;
			$this->modifiedColumns[] = ProjectEntryPeer::TEAM_ID;
		}
	...
	public function setTimeInterval($v)
	{
		...
		if ($this->time_interval !== $v) {
			...
			$this->modifiedColumns[] = ProjectEntryPeer::TIME_INTERVAL;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ProjectEntryPeer::ID;
		}
	...
	public function setDayId($v)
	{
		...
		if ($this->day_id !== $v) {
			$this->day_id = $v;
			$this->modifiedColumns[] = ProjectEntryPeer::DAY_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = ProjectEntryPeer::USER_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->time_interval = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->day_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			...
			return $startcol + 6; // 6 = ProjectEntryPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating ProjectEntry object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProjectEntryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ProjectEntryQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProjectEntryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(ProjectEntryPeer::PROJECT_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PROJECT_ID`';
		}
		if ($this->isColumnModified(ProjectEntryPeer::TEAM_ID)) {
			$modifiedColumns[':p' . $index++]  = '`TEAM_ID`';
		}
		if ($this->isColumnModified(ProjectEntryPeer::TIME_INTERVAL)) {
			$modifiedColumns[':p' . $index++]  = '`TIME_INTERVAL`';
		}
		if ($this->isColumnModified(ProjectEntryPeer::ID)) {
			$modifiedColumns[':p' . $index++]  = '`ID`';
		}
		if ($this->isColumnModified(ProjectEntryPeer::DAY_ID)) {
			$modifiedColumns[':p' . $index++]  = '`DAY_ID`';
		}
		if ($this->isColumnModified(ProjectEntryPeer::USER_ID)) {
			$modifiedColumns[':p' . $index++]  = '`USER_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `projectentries` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ProjectEntryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ProjectEntryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['ProjectEntry'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ProjectEntry'][$this->getPrimaryKey()] = true;
		$keys = ProjectEntryPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getProjectId(),
			$keys[1] => $this->getTeamId(),
			$keys[2] => $this->getTimeInterval(),
			$keys[3] => $this->getId(),
			$keys[4] => $this->getDayId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setDayId($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProjectEntryPeer::PROJECT_ID)) $criteria->add(ProjectEntryPeer::PROJECT_ID, $this->project_id);
		if ($this->isColumnModified(ProjectEntryPeer::TEAM_ID)) $criteria->add(ProjectEntryPeer::TEAM_ID, $this->team_id);
		if ($this->isColumnModified(ProjectEntryPeer::TIME_INTERVAL)) $criteria->add(ProjectEntryPeer::TIME_INTERVAL, $this->time_interval);
		if ($this->isColumnModified(ProjectEntryPeer::ID)) $criteria->add(ProjectEntryPeer::ID, $this->id);
		if ($this->isColumnModified(ProjectEntryPeer::DAY_ID)) $criteria->add(ProjectEntryPeer::DAY_ID, $this->day_id);
		if ($this->isColumnModified(ProjectEntryPeer::USER_ID)) $criteria->add(ProjectEntryPeer::USER_ID, $this->user_id);
	...
	{
		$criteria = new Criteria(ProjectEntryPeer::DATABASE_NAME);
		$criteria->add(ProjectEntryPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProjectEntry (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProjectEntry Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProjectEntryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProjectEntryPeer();
		}
		return self::$peer;
	}
	...
	public function getProject(PropelPDO $con = null)
	{
		if ($this->aProject === null && ($this->project_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aProject->addProjectEntrys($this);
			 */
		}
	...
	public function getTeam(PropelPDO $con = null)
	{
		if ($this->aTeam === null && ($this->team_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aTeam->addProjectEntrys($this);
			 */
		}
		return $this->aTeam;
	}
	...
	public function getEntry(PropelPDO $con = null)
	{
		if ($this->aEntry === null && ($this->id !== null)) {
			...
			$this->aEntry->setProjectEntry($this);
		}
		return $this->aEntry;
	}
	...
	public function getDay(PropelPDO $con = null)
	{
		if ($this->aDay === null && ($this->day_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aDay->addProjectEntrys($this);
			 */
		}
		return $this->aDay;
	}
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aUser->addProjectEntrys($this);
			 */
		}
		return $this->aUser;
	}
	...
	{
		return (string) $this->exportTo(ProjectEntryPeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function getParentOrCreate($con = null)
	{
		if ($this->isNew()) {
			if ($this->isPrimaryKeyNull()) {
				...
				$parent->setDescendantClass('ProjectEntry');
				return $parent;
			} else {
