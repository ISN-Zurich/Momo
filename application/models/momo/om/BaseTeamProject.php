...
/**
 * Base class that represents a row from the 'teams_projects' table.
 *
 * 
 *
 * @package    propel.generator.momo.om
 */
abstract class BaseTeamProject extends BaseObject 
{

	/**
	 * Peer class name
	 */
	const PEER = 'TeamProjectPeer';
	 ...
	 * @return     TeamProject The current object (for fluent API support)
	 */
	public function setTeamId($v)
	{
		...
		if ($this->team_id !== $v) {
			$this->team_id = $v;
			$this->modifiedColumns[] = TeamProjectPeer::TEAM_ID;
		}
	...
	public function setProjectId($v)
	{
		...
		if ($this->project_id !== $v) {
			$this->project_id = $v;
			$this->modifiedColumns[] = TeamProjectPeer::PROJECT_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = TeamProjectPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating TeamProject object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TeamProjectPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = TeamProjectQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				TeamProjectPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(TeamProjectPeer::TEAM_ID)) {
			$modifiedColumns[':p' . $index++]  = '`TEAM_ID`';
		}
		if ($this->isColumnModified(TeamProjectPeer::PROJECT_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PROJECT_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `teams_projects` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TeamProjectPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TeamProjectPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['TeamProject'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['TeamProject'][serialize($this->getPrimaryKey())] = true;
		$keys = TeamProjectPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TeamProjectPeer::TEAM_ID)) $criteria->add(TeamProjectPeer::TEAM_ID, $this->team_id);
		if ($this->isColumnModified(TeamProjectPeer::PROJECT_ID)) $criteria->add(TeamProjectPeer::PROJECT_ID, $this->project_id);
	...
	{
		$criteria = new Criteria(TeamProjectPeer::DATABASE_NAME);
		$criteria->add(TeamProjectPeer::TEAM_ID, $this->team_id);
		$criteria->add(TeamProjectPeer::PROJECT_ID, $this->project_id);
	...
	{
		return (null === $this->getTeamId()) && (null === $this->getProjectId());
	}
	 ...
	 *
	 * @return     TeamProjectPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TeamProjectPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(TeamProjectPeer::DEFAULT_STRING_FORMAT);
	}
