...
/**
 * Base static class for performing query and update operations on the 'teams' table.
 *
 * 
 *
...
abstract class BaseTeamPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ParentId', 'Name', 'Archived', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parentId', 'name', 'archived', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PARENT_ID, self::NAME, self::ARCHIVED, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PARENT_ID', 'NAME', 'ARCHIVED', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'parent_id', 'name', 'archived', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ParentId' => 1, 'Name' => 2, 'Archived' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'parentId' => 1, 'name' => 2, 'archived' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PARENT_ID => 1, self::NAME => 2, self::ARCHIVED => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PARENT_ID' => 1, 'NAME' => 2, 'ARCHIVED' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'parent_id' => 1, 'name' => 2, 'archived' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(TeamPeer::PARENT_ID);
			$criteria->addSelectColumn(TeamPeer::NAME);
			$criteria->addSelectColumn(TeamPeer::ARCHIVED);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to teams
	...
	/**
	 * Selects a collection of Team objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		TeamPeer::addSelectColumns($criteria);
		$startcol2 = TeamPeer::NUM_HYDRATE_COLUMNS;
