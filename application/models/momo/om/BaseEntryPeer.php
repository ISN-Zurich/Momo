...
/**
 * Base static class for performing query and update operations on the 'entries' table.
 *
 * 
 *
...
abstract class BaseEntryPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'DayId', 'UserId', 'DescendantClass', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'dayId', 'userId', 'descendantClass', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DAY_ID, self::USER_ID, self::DESCENDANT_CLASS, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DAY_ID', 'USER_ID', 'DESCENDANT_CLASS', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'day_id', 'user_id', 'descendant_class', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DayId' => 1, 'UserId' => 2, 'DescendantClass' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'dayId' => 1, 'userId' => 2, 'descendantClass' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DAY_ID => 1, self::USER_ID => 2, self::DESCENDANT_CLASS => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DAY_ID' => 1, 'USER_ID' => 2, 'DESCENDANT_CLASS' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'day_id' => 1, 'user_id' => 2, 'descendant_class' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(EntryPeer::DAY_ID);
			$criteria->addSelectColumn(EntryPeer::USER_ID);
			$criteria->addSelectColumn(EntryPeer::DESCENDANT_CLASS);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to entries
	...
	public static function doCountJoinDay(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EntryPeer::DAY_ID, DayPeer::ID, $join_behavior);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EntryPeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Entry objects pre-filled with their Day objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinDay(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Entry) to $obj2 (Day)
				$obj2->addEntry($obj1);
	...
	/**
	 * Selects a collection of Entry objects pre-filled with their User objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Entry objects.
	...
	public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Entry) to $obj2 (User)
				$obj2->addEntry($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Entry) to the collection in $obj2 (Day)
				$obj2->addEntry($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Entry) to the collection in $obj3 (User)
				$obj3->addEntry($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Entry objects pre-filled with all related objects except Day.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptDay(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = EntryPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Entry) to the collection in $obj2 (User)
				$obj2->addEntry($obj1);
	...
	/**
	 * Selects a collection of Entry objects pre-filled with all related objects except User.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Deletes all rows from the entries table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
