...
abstract class BaseProjectPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Enabled', 'Archived', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'enabled', 'archived', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::ENABLED, self::ARCHIVED, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'ENABLED', 'ARCHIVED', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'enabled', 'archived', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Enabled' => 2, 'Archived' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'enabled' => 2, 'archived' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::ENABLED => 2, self::ARCHIVED => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'ENABLED' => 2, 'ARCHIVED' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'enabled' => 2, 'archived' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ProjectPeer::ENABLED);
			$criteria->addSelectColumn(ProjectPeer::ARCHIVED);
		} else {
