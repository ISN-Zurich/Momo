...
abstract class BaseHolidayPeer {
	...
	const ID = 'holidays.ID';

	/** the column name for the WORKPLAN_ID field */
	const WORKPLAN_ID = 'holidays.WORKPLAN_ID';

	/** the column name for the DATEOFHOLIDAY field */
	const DATEOFHOLIDAY = 'holidays.DATEOFHOLIDAY';

	/** the column name for the FULLDAY field */
	const FULLDAY = 'holidays.FULLDAY';

	/** the column name for the HALFDAY field */
	const HALFDAY = 'holidays.HALFDAY';

	/** the column name for the ONEHOUR field */
	const ONEHOUR = 'holidays.ONEHOUR';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'WorkplanId', 'Dateofholiday', 'Fullday', 'Halfday', 'Onehour', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'workplanId', 'dateofholiday', 'fullday', 'halfday', 'onehour', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::WORKPLAN_ID, self::DATEOFHOLIDAY, self::FULLDAY, self::HALFDAY, self::ONEHOUR, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'WORKPLAN_ID', 'DATEOFHOLIDAY', 'FULLDAY', 'HALFDAY', 'ONEHOUR', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'workplan_id', 'dateOfHoliday', 'fullDay', 'halfDay', 'oneHour', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'WorkplanId' => 1, 'Dateofholiday' => 2, 'Fullday' => 3, 'Halfday' => 4, 'Onehour' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'workplanId' => 1, 'dateofholiday' => 2, 'fullday' => 3, 'halfday' => 4, 'onehour' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::WORKPLAN_ID => 1, self::DATEOFHOLIDAY => 2, self::FULLDAY => 3, self::HALFDAY => 4, self::ONEHOUR => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'WORKPLAN_ID' => 1, 'DATEOFHOLIDAY' => 2, 'FULLDAY' => 3, 'HALFDAY' => 4, 'ONEHOUR' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'workplan_id' => 1, 'dateOfHoliday' => 2, 'fullDay' => 3, 'halfDay' => 4, 'oneHour' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(HolidayPeer::WORKPLAN_ID);
			$criteria->addSelectColumn(HolidayPeer::DATEOFHOLIDAY);
			$criteria->addSelectColumn(HolidayPeer::FULLDAY);
			$criteria->addSelectColumn(HolidayPeer::HALFDAY);
			$criteria->addSelectColumn(HolidayPeer::ONEHOUR);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.WORKPLAN_ID');
			$criteria->addSelectColumn($alias . '.DATEOFHOLIDAY');
			$criteria->addSelectColumn($alias . '.FULLDAY');
			$criteria->addSelectColumn($alias . '.HALFDAY');
			$criteria->addSelectColumn($alias . '.ONEHOUR');
		}
	}
	...
	public static function doCountJoinWorkplan(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(HolidayPeer::WORKPLAN_ID, WorkplanPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Holiday objects pre-filled with their Workplan objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinWorkplan(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Holiday) to $obj2 (Workplan)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Holiday) to the collection in $obj2 (Workplan)
				$obj2->addHoliday($obj1);
