...
class TimetrackerController extends Momo_Controller {
	...
	public function display($day=null, $month=null, $year=null) {
		...
		//
		// new overtime calculation, relative to the end of the current working week
		$endOfWeekDateTime = DateTimeHelper::getEndOfWeek( DateTimeHelper::getDateTimeForCurrentDate() ) ;
		$newTotalOvertimeCalculationRelativeToEndOfCurrentWeek =  	  $compService->computeTotalWorktimeCreditForUser( $displayUser, $displayUser->getEntryDate(), $endOfWeekDateTime )
																	+ $compService->computeWorktimeAdjustmentsForUser( $displayUser, $displayUser->getEntryDate(), $endOfWeekDateTime )
																	- $compService->computePlanTimeForUser( $displayUser, $displayUser->getEntryDate(), $endOfWeekDateTime ) ;
/**
...
*/
		...
		$data["timetracker_totalweekhours_insec"] 			= $newTotalOvertimeCalculationRelativeToEndOfCurrentWeek ;
